...
| `/register` | Guest         | Create an account with personal details, email, and password |
...
- Registration requires first and last name, a valid email, and a 12–128 character password. Phone is optional, matching the backend contract.
