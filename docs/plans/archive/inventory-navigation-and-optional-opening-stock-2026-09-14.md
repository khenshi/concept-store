...
**Status:** Completed and reviewed. Parts 1, 2 and 3 committed as `44c01aa`, `fb105de` and `e43ff41`. The user explicitly waived rendered QA for this milestone on September 14, 2026. This archive does not authorize new implementation.
...
Part 3 and final completion; all three parts are committed and this plan is archived.
