# Archived Current Implementation Plan

This plan was archived when the approved Branch Inventory Movement Records plan
was started on September 23, 2026.
...
- Keep branch-price editing out of the placement summary, expose product-profile
  navigation as the fourth summary metric, give the receive/threshold column less
  width than correction, align Receive stock and Low-stock threshold as parallel
  controls with each action beside its input, and shorten summary separators so
  they have vertical breathing room.
